...
export default {
  namespace: 'createOfficeRentResource',
  state: {
    current: 0,
    projectId:null,
    loadingShadow:false,
  ...
  subscriptions:{
    setup({ dispatch, history }) {
         history.listen(location =>{
           if (location.pathname === '/houseResourceRentManagement/officeRent/createOfficeRentResource/officeResourceInfosRent') {
             dispatch({
               type: 'setCurrent',
               payload:0
             });
           }else if(location.pathname === '/houseResourceRentManagement/officeRent/createOfficeRentResource/officeImgsRent'){
             dispatch({
               type: 'setCurrent',
               payload:1
             });
           }else if(location.pathname === '/houseResourceRentManagement/officeRent/createOfficeRentResource/officeOwnerInfosRent'){
             dispatch({
               type: 'setCurrent',
               payload:2
             });
           }else if(location.pathname === '/houseResourceRentManagement/officeRent/createOfficeRentResource/assignAgentOfficeRent'){
             dispatch({
               type: 'setCurrent',
               payload:3
             });
