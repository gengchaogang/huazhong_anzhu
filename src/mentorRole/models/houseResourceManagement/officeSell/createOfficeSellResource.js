...
export default {
  namespace: 'createOfficeSellResource',
  state: {
    current: 0,
    projectId:null,
    loadingShadow:false,
  ...
  subscriptions:{
    setup({ dispatch, history }) {
         history.listen(location =>{
           ...
           }else if(location.pathname === '/houseResourceSaleManagement/officeSell/createOfficeSellResource/officeImgs'){
             dispatch({
               type: 'setCurrent',
               payload:1
             });
           }else if(location.pathname === '/houseResourceSaleManagement/officeSell/createOfficeSellResource/officeOwnerInfos'){
             dispatch({
               type: 'setCurrent',
               payload:2
             });
           }else if(location.pathname === '/houseResourceSaleManagement/officeSell/createOfficeSellResource/assignAgentOfficeSell'){
             dispatch({
               type: 'setCurrent',
               payload:3
             });
