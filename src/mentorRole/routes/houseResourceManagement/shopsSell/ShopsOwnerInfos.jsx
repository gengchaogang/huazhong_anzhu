...
function ShopsOwnerInfos({dispatch,shopsOwnerInfos,form}){
  ...
  var {houseBaseInfo} = shopsOwnerInfos;
    ...
    form.validateFields((err, fieldsValue) => {
      if (err) {
        ...
        return;
          ...
          dispatch({
            type:"shopsOwnerInfos/submitData",
            payload:fieldsValue,
          })
      }
    })
  ...
  const onOkCallBack=()=>{
      if(promptObj.todo==='closeModal'){
        dispatch({
          type:"shopsOwnerInfos/togglePrompt",
          payload:{
            visible:false
          }
        })
  ...
  const ownerIdentityChange=(e)=>{
    dispatch({
      type:"shopsOwnerInfos/changeOwnerIdentity",
      payload:{
  ...
  const deletePic=(id)=>{
      confirm({
          ...
          onOk() {
            dispatch({
                type:"shopsOwnerInfos/deletePic",
                payload:{
                  id:id,
                }
            })
...
function mapStateToProps({shopsOwnerInfos}){
  return{shopsOwnerInfos}
}
export default connect(mapStateToProps)(Form.create({})(ShopsOwnerInfos));
