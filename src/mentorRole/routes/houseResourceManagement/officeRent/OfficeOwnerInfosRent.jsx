...
import './officeOwnerInfosRent.css'
...
function OfficeOwnerInfosRent({dispatch,officeOwnerInfosRent,form}){
  ...
  var {houseBaseInfo} = officeOwnerInfosRent;
  ...
  const upLoadIdPicProps={  //上传身份证附件
    ...
    changeList:(data)=>{
      dispatch({
        type:"officeOwnerInfosRent/setState",
        payload:{
          showIdPicList:data,
        }
      })
    ...
    form.validateFields((err, fieldsValue) => {
      if (err) {
        ...
        return;
          ...
          dispatch({
            type:"officeOwnerInfosRent/submitData",
            payload:fieldsValue,
          })
      }
    })
  ...
  const onOkCallBack=()=>{
      if(promptObj.todo==='closeModal'){
        dispatch({
          type:"officeOwnerInfosRent/togglePrompt",
          payload:{
            visible:false
          }
        })
  ...
  const ownerIdentityChange=(e)=>{
    dispatch({
      type:"officeOwnerInfosRent/changeOwnerIdentity",
      payload:{
  ...
  const deletePic=(id)=>{
      confirm({
          ...
          onOk() {
            dispatch({
                type:"officeOwnerInfosRent/deletePic",
                payload:{
                  id:id,
                }
            })
...
function mapStateToProps({officeOwnerInfosRent}){
  return{officeOwnerInfosRent}
}
export default connect(mapStateToProps)(Form.create({})(OfficeOwnerInfosRent));
