...
function CreateOfficeRentResource(props) {
  const { dispatch, createOfficeRentResource, children, promptObj, loadingShadow,
  } = props;
  const { current } = createOfficeRentResource
...
function mapStateToProps({ createOfficeRentResource }) {
  return { createOfficeRentResource }
}
