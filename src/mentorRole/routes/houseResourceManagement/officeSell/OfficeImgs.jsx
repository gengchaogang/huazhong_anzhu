...
function OfficeImgs({dispatch,officeImgs}){
  const {
    showPicList,promptObj,loadingShadow,picListData,
    } = officeImgs;

  var {houseBaseInfo} = officeImgs;
...
function mapStateToProps({officeImgs}){
  return{officeImgs}
}
export default connect(mapStateToProps)(OfficeImgs)
