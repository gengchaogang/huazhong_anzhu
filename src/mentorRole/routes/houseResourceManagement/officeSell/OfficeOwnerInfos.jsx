...
function OfficeOwnerInfos({dispatch,officeOwnerInfos,form}){
  ...
  var {houseBaseInfo} = officeOwnerInfos;
  ...
  const upLoadIdPicProps={  //上传身份证附件
    ...
    changeList:(data)=>{
      dispatch({
        type:"officeOwnerInfos/setState",
        payload:{
          showIdPicList:data,
        }
      })
    ...
    form.validateFields((err, fieldsValue) => {
      if (err) {
        ...
        return;
          ...
          dispatch({
            type:"officeOwnerInfos/submitData",
            payload:fieldsValue,
          })
      }
    })
  ...
  const onOkCallBack=()=>{
      if(promptObj.todo==='closeModal'){
        dispatch({
          type:"officeOwnerInfos/togglePrompt",
          payload:{
            visible:false
          }
        })
  ...
  const ownerIdentityChange=(e)=>{
    dispatch({
      type:"officeOwnerInfos/changeOwnerIdentity",
      payload:{
  ...
  const deletePic=(id)=>{
      confirm({
          ...
          onOk() {
            dispatch({
                type:"officeOwnerInfos/deletePic",
                payload:{
                  id:id,
                }
            })
...
function mapStateToProps({officeOwnerInfos}){
  return{officeOwnerInfos}
}
export default connect(mapStateToProps)(Form.create({})(OfficeOwnerInfos));
