...
import './shopsOwnerInfosRent.css'
...
function ShopsOwnerInfosRent({dispatch,shopsOwnerInfosRent,form}){
  ...
  var {houseBaseInfo} = shopsOwnerInfosRent;
  ...
  const upLoadIdPicProps={  //上传身份证附件
    ...
    changeList:(data)=>{
      dispatch({
        type:"shopsOwnerInfosRent/setState",
        payload:{
          showIdPicList:data,
        }
      })
    ...
    form.validateFields((err, fieldsValue) => {
      if (err) {
        ...
        return;
          ...
          dispatch({
            type:"shopsOwnerInfosRent/submitData",
            payload:fieldsValue,
          })
      }
    })
  ...
  const onOkCallBack=()=>{
      if(promptObj.todo==='closeModal'){
        dispatch({
          type:"shopsOwnerInfosRent/togglePrompt",
          payload:{
            visible:false
          }
        })
  ...
  const ownerIdentityChange=(e)=>{
    dispatch({
      type:"shopsOwnerInfosRent/changeOwnerIdentity",
      payload:{
  ...
  const deletePic=(id)=>{
      confirm({
          ...
          onOk() {
            dispatch({
                type:"shopsOwnerInfosRent/deletePic",
                payload:{
                  id:id,
                }
            })
...
function mapStateToProps({shopsOwnerInfosRent}){
  return{shopsOwnerInfosRent}
}
export default connect(mapStateToProps)(Form.create({})(ShopsOwnerInfosRent));
