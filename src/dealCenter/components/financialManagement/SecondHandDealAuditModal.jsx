...
function SecondHandDealAuditModal({dispatch, secondHandHouseFinancialSalesAudit}){
	const {projectDealAuditModal, auditExplainModal} = secondHandHouseFinancialSalesAudit;
		...
		dispatch({
			...
			payload:{
				...
				onSubmit:(values)=>{
						...
						//getInitSecondHandDealTableData secondHandDealPass
						dispatch({
							type:"secondHandHouseFinancialSalesAudit/secondHandDealPass",
							payload:values
						})
				}
			}
		...
		dispatch({
			...
			payload:{
				...
				onSubmit:(values)=>{
					...
					dispatch({
						type:"secondHandHouseFinancialSalesAudit/secondHandDealReject",
						payload:values
					})
				},
			}
