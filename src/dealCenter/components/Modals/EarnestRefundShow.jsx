...
function EarnestRefundShow({dispatch,secondDeal}){
	const {
		EarnestShowButton,
	...
	return(
		<Modal
			visible={earnestRefundModalVisible}
			maskClosable={false}
			title="二手房--意向金退款申请"
...
export default connect(mapStateToProps)(EarnestRefundShow);
