...
import './SHSellCommissionRefundApply.css'
const steps =[
  '申请退款',
  '退款审核',
  '财务审核',
...
const SHSellCommissionRefundApply=({dispatch,shSellCommissionRefundApply:{
  promptObj,
  upLoadPicList,
  auditorList,
  orderInfo,
  ...
  function updateApplyForm(){
    validateFields((errors) => {
      ...
      dispatch({
        type:'shSellCommissionRefundApply/postRefundApplyData',
        payload:data,
      })
    });
  }
  ...
  return (
    <div className='shSellCommissionRefundApply'>
      <PromptModal {...promptObj} onOk={()=>dispatch({type:'shSellCommissionRefundApply/closePrompt'})} onCancel={()=>dispatch({type:'shSellCommissionRefundApply/closePrompt'})}/>
      <DxPanel title='二手房出售佣金退款申请'>
        ...
        <DxPanelMini title='退款理由'>
          <div style={{paddingTop:'20px'}}>
            ...
            <DxUpLoadPic {...upLoadProps} changeList={(arr)=>dispatch({type:'shSellCommissionRefundApply/updatePicList',payload:arr})}
...
SHSellCommissionRefundApply.propTypes = {
  shSellCommissionRefundApply: PropTypes.object,
...
function mapStateToProps({shSellCommissionRefundApply}) {
  return {shSellCommissionRefundApply}
}
export default connect(mapStateToProps)(Form.create()(SHSellCommissionRefundApply));
