...
const SecondHouseSellTransaction = ({location, dispatch,secondHouseSellTransaction}) => {
...
SecondHouseSellTransaction.propTypes = {
  secondHouseSellTransaction: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
}

function mapStateToProps({secondHouseSellTransaction}) {
  return {secondHouseSellTransaction}
}

export default connect(mapStateToProps)(SecondHouseSellTransaction)
