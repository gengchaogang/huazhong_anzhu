...
import './SHRentIntentsRefundAuditInfo.css'
...
const SHRentIntentsRefundAuditInfo=({dispatch,shRentIntentsRefundAuditInfo:{
  promptObj,
  upLoadPicList,
  auditorList,
  orderInfo,
  ...
  return (
    <div className='shRentIntentsRefundAuditInfo applyInfoCom'>
      {!!revokeRefundModal.visible && <RevokeRefundModal {...revokeRefundModal} applyCallBack={(data)=>dispatch({
          type:'shRentIntentsRefundAuditInfo/postRevokeRefundData',
          payload:data,
        })} closeModal={()=>dispatch({type:'shRentIntentsRefundAuditInfo/closeRevokeRefund'})}/>}
      <PromptModal {...promptObj} onOk={()=>dispatch({type:'shRentIntentsRefundAuditInfo/closePrompt'})} onCancel={()=>dispatch({type:'shRentIntentsRefundAuditInfo/closePrompt'})}/>
      <DxPanel title='二手房出售意向金退款申请审核详情'>
        ...
        <div className='anzhua_button_bottom'>
          {!!canRevoke && <Button type='primary' onClick={()=>dispatch({
            type:'shRentIntentsRefundAuditInfo/readyRevokeApply',
...
SHRentIntentsRefundAuditInfo.propTypes = {
  shRentIntentsRefundAuditInfo: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
}
function mapStateToProps({shRentIntentsRefundAuditInfo}) {
  return {shRentIntentsRefundAuditInfo}
}
export default connect(mapStateToProps)(SHRentIntentsRefundAuditInfo);
