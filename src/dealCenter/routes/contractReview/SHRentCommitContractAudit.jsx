...
import './SHRentCommitContractAudit.css'
...
const SHRentCommitContractAudit=({dispatch,shRentCommitContractAudit:{
  promptObj,
  upLoadPicList,
  loading,
  auditorList,
  ...
  return (
    <div className='shRentCommitContractAudit applyInfoCom'>
      {!!loading && <DxLoadingShadow visible={!!loading}/>}
      <DxAuditModal {...auditModalProps} {...auditModal} doAudit={(data)=>dispatch({
          type:'shRentCommitContractAudit/doAudit',
          payload:data,
        })} closeModal={()=>dispatch({
          type:'shRentCommitContractAudit/cancelAudit'
        })} afterClose={()=>dispatch({
          type:'shRentCommitContractAudit/afterCloseAuditModal'
        })}/>
      <PromptModal {...promptObj} onOk={()=>dispatch({type:'shRentCommitContractAudit/closePrompt'})} onCancel={()=>dispatch({type:'shRentCommitContractAudit/closePrompt'})}/>
        ...
        <div>
          ...
          <div className='anzhua_button_bottom'>
            {!!canAudit && <Button type='primary' onClick={()=>dispatch({
                type:'shRentCommitContractAudit/updateAudit',
                payload:'pass',
              })}>审核通过</Button>}
...
SHRentCommitContractAudit.propTypes = {
  shRentCommitContractAudit: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
}
function mapStateToProps({shRentCommitContractAudit}) {
  return {shRentCommitContractAudit}
}
export default connect(mapStateToProps)(SHRentCommitContractAudit);
