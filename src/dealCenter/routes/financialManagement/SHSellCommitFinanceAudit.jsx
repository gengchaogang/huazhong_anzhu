...
import './SHSellCommitFinanceAudit.css'
...
const SHSellCommitFinanceAudit=({dispatch,shSellCommitFinanceAudit:{
  promptObj,
  upLoadPicList,
  loading,
  auditorList,
  ...
  return (
    <div className='shSellCommitFinanceAudit'>
      {!!loading && <DxLoadingShadow visible={!!loading}/>}
      <DxAuditModal {...auditModalProps} {...auditModal} doAudit={(data)=>dispatch({
          type:'shSellCommitFinanceAudit/doAudit',
          payload:data,
        })} closeModal={()=>dispatch({
          type:'shSellCommitFinanceAudit/cancelAudit'
        })} afterClose={()=>dispatch({
          type:'shSellCommitFinanceAudit/afterCloseAuditModal'
        })}/>
      <PromptModal {...promptObj} onOk={()=>dispatch({type:'shSellCommitFinanceAudit/closePrompt'})} onCancel={()=>dispatch({type:'shSellCommitFinanceAudit/closePrompt'})}/>
        ...
        <div>
          ...
          <div className='anzhua_button_bottom'>
            {!!canAudit && <Button type='primary' onClick={()=>dispatch({
                type:'shSellCommitFinanceAudit/updateAudit',
                payload:'pass',
              })}>审核通过</Button>}
...
SHSellCommitFinanceAudit.propTypes = {
  shSellCommitFinanceAudit: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
}
function mapStateToProps({shSellCommitFinanceAudit}) {
  return {shSellCommitFinanceAudit}
}
export default connect(mapStateToProps)(SHSellCommitFinanceAudit);
