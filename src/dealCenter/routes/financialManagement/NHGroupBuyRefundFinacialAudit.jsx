...
import './NHGroupBuyRefundFinacialAudit.css'
...
const NHGroupBuyRefundFinacialAudit=({dispatch,nhGroupBuyRefundFinacialAudit:{
  promptObj,
  upLoadPicList,
  loading,
  auditorList,
  ...
  return (
    <div className='nhGroupBuyRefundFinacialAudit applyInfoCom'>
      {!!loading && <DxLoadingShadow visible={!!loading}/>}
      <DxAuditModal {...auditModalProps} {...auditModal} doAudit={(data)=>dispatch({
          type:'nhGroupBuyRefundFinacialAudit/doAudit',
          payload:data,
        })} closeModal={()=>dispatch({
          type:'nhGroupBuyRefundFinacialAudit/cancelAudit'
        })} afterClose={()=>dispatch({
          type:'nhGroupBuyRefundFinacialAudit/afterCloseAuditModal'
        })}/>
      <PromptModal {...promptObj} onOk={()=>dispatch({type:'nhGroupBuyRefundFinacialAudit/closePrompt'})} onCancel={()=>dispatch({type:'nhGroupBuyRefundFinacialAudit/closePrompt'})}/>
      <DxPanel title='电商团购退款财务审核'>
        <div>
          ...
          <div className='anzhua_button_bottom'>
            {!!canAudit && <Button type='primary' onClick={()=>dispatch({
                type:'nhGroupBuyRefundFinacialAudit/updateAudit',
                payload:'pass',
              })}>审核通过</Button>}
...
NHGroupBuyRefundFinacialAudit.propTypes = {
  nhGroupBuyRefundFinacialAudit: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
}
function mapStateToProps({nhGroupBuyRefundFinacialAudit}) {
  return {nhGroupBuyRefundFinacialAudit}
}
export default connect(mapStateToProps)(NHGroupBuyRefundFinacialAudit);
