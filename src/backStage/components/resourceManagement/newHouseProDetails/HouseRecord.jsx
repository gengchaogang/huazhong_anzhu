  ...
  return(
    <DxPanel title="带看记录">
      <Table
        ...
        title={() =><div><Button type='primary' onClick={searchAll}>全部</Button><Button type='primary' onClick={searchSeen}>已带看</Button><Button type='primary' onClick={notToSee}>未带看</Button><Button type='primary' onClick={missTo}>爽约</Button></div>}
      />
    </DxPanel>
  )
}
