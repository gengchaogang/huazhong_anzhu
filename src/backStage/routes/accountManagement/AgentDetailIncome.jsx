...
import './AgentDetailIncome.css';
import DxPanel from '../../../commons/components/DxPanel'
function AgentDetailIncome({dispatch,agentDetailIncome}) {
  const {
    customer,
    customerPhone,
    house,
...
AgentDetailIncome.propTypes = {

};
function mapStateToProps({agentDetailIncome }) {
	return { agentDetailIncome }
}

export default connect(mapStateToProps)(AgentDetailIncome)
