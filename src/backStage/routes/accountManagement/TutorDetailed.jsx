...
function TutorDetailed({dispatch,tutorDetailed,form}) {
  const {
    type,
    area,
    bank,
...
TutorDetailed.propTypes = {

};
function mapStateToProps({tutorDetailed }) {
	return { tutorDetailed }
}

export default connect(mapStateToProps)(Form.create()(TutorDetailed))
