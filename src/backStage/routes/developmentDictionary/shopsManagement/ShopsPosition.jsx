...
import './ShopsPosition.css'
import SearchInput from '../../../../commons/View/SearchInput'

function ShopsPosition({dispatch}) {
...
function mapStateToProps({shopsPosition}) {
  return {shopsPosition}
}

export default connect(mapStateToProps)(ShopsPosition);
