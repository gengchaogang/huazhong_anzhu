...
function SecHandRentedRecord({dispatch,secHandRentedRecord}){
  const {
    currentStatus,
    tableData,
    totalElements,
  ...
  const toNext=()=>{
    dispatch(routerRedux.push({
      pathname:'/resourceManagement/secondhandHouseRent/secHandRentedNavBar/secHandRentedDeal',
      state:{
        projectId:projectId
      }
    }))
...
function mapStateToProps({secHandRentedRecord}){
  return{secHandRentedRecord}
}
export default connect(mapStateToProps)(SecHandRentedRecord);
