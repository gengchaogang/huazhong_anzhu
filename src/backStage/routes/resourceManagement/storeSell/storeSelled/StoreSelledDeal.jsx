...
function StoreSelledDeal({dispatch,storeSelledDeal}){
  const {
    promptObj,
    projectId
  }=storeSelledDeal;
...
function mapStateToProps({storeSelledDeal}){
  return{storeSelledDeal}
}
export default connect(mapStateToProps)(StoreSelledDeal)
