...
function StoreRentedDeal({dispatch,storeRentedDeal}){
  const {
    promptObj,
    projectId
  }=storeRentedDeal;
...
function mapStateToProps({storeRentedDeal}){
  return{storeRentedDeal}
}
export default connect(mapStateToProps)(StoreRentedDeal)
