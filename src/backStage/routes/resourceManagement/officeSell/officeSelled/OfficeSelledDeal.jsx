...
function OfficeSelledDeal({dispatch,officeSelledDeal}){
  const {
    promptObj,
    projectId
  }=officeSelledDeal;
...
function mapStateToProps({officeSelledDeal}){
  return{officeSelledDeal}
}
export default connect(mapStateToProps)(OfficeSelledDeal)
