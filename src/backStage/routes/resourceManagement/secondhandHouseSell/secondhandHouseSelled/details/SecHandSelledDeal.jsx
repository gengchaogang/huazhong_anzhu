...
function SecHandSelledDeal({dispatch,secHandSelledDeal}){
  const {
    promptObj,
    projectId
  }=secHandSelledDeal;
  ...
  return (
    <div className="selled-strike-hands">
...
function mapStateToProps({secHandSelledDeal}){
  return{secHandSelledDeal}
}
export default connect(mapStateToProps)(SecHandSelledDeal)
