import {findAll,addRooms,editRooms} from '../../services/developmentDictionary/watchHousingNumberShop';
import { parse } from 'qs';
import { message} from 'antd';
export default {
	namespace: 'watchHousingNumberShop',
	state: {
    id:'',
    totalNumberOfFloors:'',
    household:'',
  ...
  subscriptions:{
		setup({ dispatch, history }) {
			history.listen(location => {
				if (location.pathname === '/developmentDictionary/shopsManagement/watchHousingNumberShop') {
					dispatch({
            type:'findAll',
            payload:{
