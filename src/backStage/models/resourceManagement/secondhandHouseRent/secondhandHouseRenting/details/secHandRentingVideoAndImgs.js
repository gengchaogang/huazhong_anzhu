import {
  getInitImgDataFetch,
} from  '../../../../../services/resourceManagement/newHouseProDetails/detailsVideoAndImgs'
import { routerRedux } from 'dva/router';
export default {
  namespace: 'secHandRentingVideoAndImgs',
  state: {
    initData:[],
    projectId:null,
    modalVisible:false,
  ...
  subscriptions:{
    setup({ dispatch, history }) {
         history.listen(location =>{
           if (location.pathname === '/resourceManagement/secondhandHouseRent/secHandRentingNavBar/secHandRentingVideoAndImgs') {
