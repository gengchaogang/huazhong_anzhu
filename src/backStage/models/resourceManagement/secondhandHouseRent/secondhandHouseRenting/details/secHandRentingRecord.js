import {
  getInitDataFetch,
} from  '../../../../../services/resourceManagement/newHouseProDetails/detailsRecord'
import { routerRedux } from 'dva/router';
export default {
  namespace: 'secHandRentingRecord',
  state: {
    currentStatus:"",
    tableData:[],
    totalElements:null,
  ...
  subscriptions:{
    setup({ dispatch, history }) {
         history.listen(location =>{
           if (location.pathname === '/resourceManagement/secondhandHouseRent/secHandRentingNavBar/secHandRentingRecord') {
             dispatch({
