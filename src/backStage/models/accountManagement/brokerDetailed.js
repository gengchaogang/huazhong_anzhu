...
fingBrokerOrTutorWalletExpenseFetch} from '../../services/accountManagement/brokerDetailed';
import { parse } from 'qs';
import {message} from 'antd';

export default {
	namespace: 'brokerDetailed',
	state: {
    type:'',
    area:'',
    bank:'',
  ...
  subscriptions:{
		setup({ dispatch, history }) {
			history.listen(location => {
				if (location.pathname === '/accountManagement/zhangHuGuanLiBroker/brokerDetailed') {
