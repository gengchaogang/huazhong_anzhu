import {findAccountsFetch} from '../../services/accountManagement/zhangHuGuanLiBroker';
import { parse } from 'qs';
import {message} from 'antd';

export default {
	namespace: 'zhangHuGuanLiBroker',
	state: {
		dataSource:[],
		total:'',
		pageNo:0,
  ...
  subscriptions:{
		setup({ dispatch, history }) {
			history.listen(location => {
				if (location.pathname === '/accountManagement/zhangHuGuanLiBroker') {
